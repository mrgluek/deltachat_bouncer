...
### Added
- **New Admin Command `/cmfaillist`:** Shows currently failing monitored links, grouped by server, to quickly identify down servers without displaying the whole matrix.
